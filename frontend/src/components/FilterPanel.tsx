...
// カテゴリ名から翻訳キーへのマッピング（codeConstants の CATEGORY_I18N_KEYS を単一の出所として導出）
const CATEGORY_TO_I18N_KEY: Record<string, string> = Object.fromEntries(
  Object.entries(CATEGORY_LABELS).map(([code, name]) => [name, CATEGORY_I18N_KEYS[Number(code)]])
)
