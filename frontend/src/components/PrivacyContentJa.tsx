  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        ...
        <p className="text-sm text-gray-700">
          本ポリシーにおいて「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれるメールアドレス、表示名その他の記述等により特定の個人を識別できる情報を指します。
        </p>
      </section>
      ...
      <section>
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
          ...
          <li>
            プロフィール情報の一部（表示名、プロフィール画像、SNSアカウントリンク）は、ユーザー自身で本サービス上から変更・削除することができます。
          </li>
        </ol>
      </section>
