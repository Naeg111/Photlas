...
describe('PhotoContributionDialog - Issue#135 キーワードセクション組込', () => {
  beforeEach(() => {
    ...
    mockAnalyzePhoto.mockResolvedValue({
      // 親カテゴリ (植物=206) を含めることで、AI 提案 tag が「選択中の小カテゴリー」
      // (文脈連動エリア) に表示される現実的なケースを再現
      categories: [206],
      weather: null,
      confidence: {},
      analyzeToken: 'token',
  ...
  it('Issue#135 / 統合: ファイル選択後、analyzePhoto の suggestedTags は「選択中の小カテゴリー」エリアに表示される', async () => {
