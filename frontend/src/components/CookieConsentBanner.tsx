 ...
 *
 * Safariツールバーの色検出対策:
 * position:fixedではなくposition:absoluteを使用し、Safariが
 * ツールバー色の検出対象としないようにする。
 * 親要素（App.tsxのrelativeコンテナ）内でbottomに配置する。
 */
export function CookieConsentBanner() {
  ...
  return (
    <div
      ...
      className="absolute bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-lg p-4"
