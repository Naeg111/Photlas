 ...
 *
 * オーバーレイはz-index: 1で地図の上に配置する
 * 親コンテナにはoverflow-hiddenを使用し、isolation: isolateは
 * iOS Safariで大画面端末のGPUコンポジティング問題を引き起こすため使用しない
 */
 ...
 * z-index: 1で地図キャンバスの上、Mapboxコントロール（z-index: 2）の下に配置
 */
const overlayStyles = {
  container: {
    position: 'absolute',
