...
export function PlaceSearchDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      <div className="absolute top-[calc(91px+env(safe-area-inset-top,0px))] left-[30px] right-[30px] md:left-1/2 md:-translate-x-1/2 md:max-w-md max-w-[448px] mx-auto pointer-events-auto flex flex-col gap-1">
        {/* 検索ボックス */}
        <Input
          type="text"
          placeholder="場所を検索"
