...
※ Claude Codeによるコミットであることは記載しないでください。
...
│   ├── 01_構成管理/      # インフラ構成・AWS設定内容
│   ├── 02_要件定義/      # プロダクト要件 & エピック
│   ├── 03_機能仕様/      # 個別機能の詳細仕様
│   ├── 04_設計/          # アーキテクチャ・DB・API・UI・規約
│   ├── 05_Issues/        # Issue管理
│   ├── 06_試験管理/      # テスト仕様書・実施レポート
│   ├── 07_メモ/          # 調査メモ・チェックリスト
│   └── 08_学習教材/      # 技術解説・ガイド
└── docker-compose.yml
```
...
**必ず `documents/04_設計/05_coding_standards.md` に定義された規約を遵守してください。**
...
**詳細は `documents/04_設計/05_coding_standards.md` を参照してください。**
...
- Issue ドキュメントは `documents/05_Issues/Issue#XX.md` に配置
